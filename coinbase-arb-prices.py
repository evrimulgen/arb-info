...
ltcusd_arb = (((EXAMPLE_ARB_BTC / ltcbtc_price) * ltcusd_price) / btcusd_price) - (TRANSACTFEE_BTC + (TRANSACTFEE_LTC *2))
ltceur_arb = (((EXAMPLE_ARB_BTC / ltcbtc_price) * ltceur_price) / btceur_price) - (TRANSACTFEE_BTC + (TRANSACTFEE_LTC *2))
print "==="
print "LTC:"
print "USD native: {} usd".format(ltcusd_price)
print "USD: {} usd [{} btc arbed: {}, arb profit: {} btc/{} usd]".format(ltcbtc_price * btcusd_price, EXAMPLE_ARB_BTC, ltcusd_arb, ltcusd_arb - EXAMPLE_ARB_BTC, (ltcusd_arb - EXAMPLE_ARB_BTC) * btcusd_price)
print "EUR: {} usd [{} btc arbed: {}, arb profit: {} btc/{} usd]".format(ltceur_price / btceur_price * btcusd_price, EXAMPLE_ARB_BTC, ltceur_arb, ltceur_arb- EXAMPLE_ARB_BTC, (ltceur_arb - EXAMPLE_ARB_BTC) * btcusd_price)

ethusd_arb = (((EXAMPLE_ARB_BTC / ethbtc_price) * ethusd_price) / btcusd_price) - (TRANSACTFEE_BTC + (TRANSACTFEE_ETH *2))
etheur_arb = (((EXAMPLE_ARB_BTC / ethbtc_price) * etheur_price) / btceur_price) - (TRANSACTFEE_BTC + (TRANSACTFEE_ETH *2))
print "==="
print "ETH:"
print "USD native: {} usd".format(ethusd_price)
print "USD: {} usd [{} btc arbed: {}, profit: {} btc/{} usd]".format(ethbtc_price * btcusd_price, EXAMPLE_ARB_BTC, ethusd_arb, ethusd_arb - EXAMPLE_ARB_BTC, (ethusd_arb - EXAMPLE_ARB_BTC) * btcusd_price)
print "EUR: {} usd [{} btc arbed: {}, profit: {} btc/{} usd]".format((etheur_price / btceur_price) * btcusd_price, EXAMPLE_ARB_BTC, etheur_arb, etheur_arb - EXAMPLE_ARB_BTC, (etheur_arb - EXAMPLE_ARB_BTC) * btcusd_price)
